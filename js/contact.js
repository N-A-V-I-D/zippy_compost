...
obj.addEventListener('click',function(){
  ...
  text += "<h1 class='response'>Thank you for contacting us, "+ name + " !</h1> <br> <br> <h3 class='response'>We will review your request and get back to you in 0-2 business days. </h3><a href='index.html'><button id='responseButton' type='button' name='button'> Home Page</button></a></body></html>";
  document.write(text);
})
